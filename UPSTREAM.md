...
Continuum memory engine. The Compose file pins the tested engine image source to
the `SYNTARUS_ENGINE_REF` commit in the upstream MemoryOS repository. This keeps
the Continuum distribution small, reproducible, and separate from hosted control
